...
public class US308Test {
    ...
    public void teste1() throws FileNotFoundException {
        ...
        lista = us308.getCabazesAtSomeDay(cabazes,listaProdutores, dia);
        us308.printList(lista, listaProdutores, dia);
    }
    @Test
    ...
    public void teste6(){
        ...
        dia = 1;
        assertEquals(null, lista = us308.getCabazesAtSomeDay(cabazesNull, listaProdutores, dia));
    }
}
